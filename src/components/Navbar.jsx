      ...
      <div className="flex items-center h-fit justify-between px-[32px] py-[16px] relative max-lg:px-[12px]">
        ...
        <nav className="absolute transform -translate-x-1/2 left-1/2 max-md:hidden">
          <ul className="flex items-center space-x-6 text-center">
            ...
            <Link to='/homedecor'><li className="hover:underline hover:decoration-solid">Home Decor</li></Link>
            <Link to='/bathbody'><li className="hover:underline hover:decoration-solid">Bath & Body</li></Link>
            <Link to='/apparel'><li className="hover:underline hover:decoration-solid">Apparel</li></Link>
            <Link to='/accessories'><li className="hover:underline hover:decoration-solid">Accessories</li></Link>
          </ul>
        </nav>
