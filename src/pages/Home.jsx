...
const Home = () => {
  ...
  useEffect(() => {
    ...
    setSelectedItem(
      firstProductByCategory.find((item) => item._id === initialProduct[0])
    );
  ...
  return (
    <div className="pt-custom flex flex-col items-center text-black bg-[#FAF7F0]">
      {/* ส่วนลดสูงสุด 50% */}
      <div
        className="flex justify-center w-full md:h-screen h-fit"
      ...
      <div className="flex justify-center w-full md:overflow-hidden">
        <div className="flex flex-col px-4 py-8 p-[84px] mx-auto max-w-[1280px] md:px-12">
          {/* ส่วนหัวข้อ */}
          <h1 className="md:text-[96px] text-7xl max-md:text-center font-bold mb-8">
            Bestseller
          </h1>
          ...
          <div className="flex flex-col items-center gap-4 mx-auto md:flex-row md:gap-12 md:relative">
            ...
            <div className="flex flex-row items-center gap-4 max-md:p-[16px] relative">
              {/* รูปแรก */}
              <div className="relative lg:w-[700px] lg:h-[700px] w-[70vw] h-[70vw] flex-none overflow-hidden">
                {bestSeller.map((item, index) => (
                  <img
                    key={index}
                    className={`absolute inset-0 object-cover w-full h-full rounded-lg transition-all duration-700 ease-in-out ${
                      currentIndex === index
              ...
              {/* รูปสอง */}
              <div className="lg:w-[400px] lg:h-[400px] w-[40vw] h-[40vw] relative flex-none max-md:hidden overflow-hidden">
                <img
                  className="object-cover w-full h-full rounded-lg transition-transform duration-500 ease-in-out scale-95"
              ...
              {/* รูปสาม */}
              <div className="lg:w-[400px] lg:h-[400px] w-[40vw] h-[40vw] relative flex-none max-lg:hidden overflow-hidden">
                <img
                  className="object-cover w-full h-full rounded-lg  transition-transform duration-500 ease-in-out scale-95"
      ...
      <div className="flex justify-center w-full">
        <div className="md:p-[84px] p-[16px] h-fit flex flex-col items-center gap-4 md:max-w-[1280px] w-full mx-auto">
          <h1 className="w-fit font-bold text-center text-7xl md:text-[96px] md:text-left">
            Category
          </h1>
          {/* mobile */}
          ...
          <div className="flex items-center justify-between gap-8 max-md:hidden">
            <div className="flex flex-col gap-6">
                  ...
                  return (
                    <button
                      ...
                      className={`px-6 py-2 bg-white border border-black ${
                        ...
                        index === firstProductByCategory.length - 1 &&
                        "rounded-e-full"
                      }`}
                    >
                      {item.category}
              ...
              <img
                className="object-cover h-[500px] w-[700px]"
            ...
            <div key={selectedItem?.id} className="h-[460px] w-[300px]">
              <div className="w-[300px] justify-between flex flex-col">
                ...
                <button className="button">
                  <Link to="/homeallproducts">Explore more</Link>
                </button>
              </div>
            </div>
          </div>
